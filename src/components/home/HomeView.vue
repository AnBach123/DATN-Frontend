  ...
  <div class="home">
    ...
    <section class="hero text-center text-white">
      <div class="overlay">
        <div class="container hero-content">
          ...
          <div class="mt-4">
            <button class="btn btn-light btn-lg me-3">ĐẶT BÀN NGAY</button>
    ...
    <section class="menu-section">
      <div class="container">
        ...
        <div v-else-if="products.length === 0" class="text-center text-white">Chưa có sản phẩm</div>
...
.hero {
  height: 550px;
  background: url('https://images.unsplash.com/photo-1559847844-5315695dadae') center/cover
    no-repeat;
}
